...
return [
    ...
    'timestamp' => 1613445267,
    'checksum' => '48e433a0e03dd5aa69ad97d8a0eab4b3',
    'files' => [
        'user/config' => [
            'groups' => [
            ...
            'plugins/persistent-data' => [
                'file' => 'user/config/plugins/persistent-data.yaml',
                'modified' => 1535502008
            ],
            'plugins/users-page-ownership' => [
                'file' => 'user/config/plugins/users-page-ownership.yaml',
                'modified' => 1535502014
            ],
            'security' => [
        ...
        'user/plugins' => [
            ...
            'plugins/persistent-data' => [
                'file' => 'user/plugins/persistent-data/persistent-data.yaml',
                'modified' => 1535501596
            ],
            'plugins/problems' => [
    ...
    'data' => [
        'plugins' => [
            ...
            'form' => [
                ...
                'recaptcha' => [
                    'secret_key' => '6Lepgk8UAAAAACQZ9SgUEJKYonwCZ9YqcUHv2Ybe',
                    'site_key' => '6Lepgk8UAAAAAFl4jVUJ_caSPmYCCRxKyDcxXOBB'
                ]
            ],
            'ganalytics' => [
                'enabled' => true,
                'trackingId' => 'UA-44378419-1',
                'position' => 'head',
                'objectName' => 'ga',
                'forceSsl' => false,
                'async' => false,
        ...
        'groups' => [
            'Tools' => [
                'groupname' => 'Tools',
                'description' => 'Paid subscribers with access to downloadable tools',
                'access' => [
                    'site' => [
                        'subscribed' => true
                    ],
        ...
        'themes' => [
            'quark' => [
                ...
                'custom_logo' => [
                    'user/themes/quark/images/logo/chartvps-logo.png' => [
                        'name' => 'chartvps-logo.png',
                        'type' => 'image/png',
                        'size' => 6581,
                        'path' => 'user/themes/quark/images/logo/chartvps-logo.png'
                    ]
                ],
                'custom_logo_mobile' => [
                    'user/themes/quark/images/logo/logo-chartvps-mobile.png' => [
                        'name' => 'logo-chartvps-mobile.png',
                        'type' => 'image/png',
                        'size' => 21946,
                        'path' => 'user/themes/quark/images/logo/logo-chartvps-mobile.png'
                    ]
                ]
            ]
        ]
