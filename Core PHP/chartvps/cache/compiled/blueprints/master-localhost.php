...
return [
    ...
    'timestamp' => 1613445278,
    'checksum' => '44fa9f067d1deca7524bb693cc8fd7cf',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/persistent-data' => [
                'file' => 'user/plugins/persistent-data/blueprints.yaml',
                'modified' => 1535501596
            ],
            'plugins/problems' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.persistent-data.enabled' => [
                'type' => 'toggle',
                'label' => 'Plugin status',
                'highlight' => 1,
                'default' => 0,
                ...
                'name' => 'plugins.persistent-data.enabled',
                'validation' => 'strict'
            ],
            'plugins.persistent-data.forget_on_logout' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.persistent-data.forget_on_logout',
                'validation' => 'strict'
            ],
            'plugins.problems' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'persistent-data' => [
                    'enabled' => 'plugins.persistent-data.enabled',
                    'forget_on_logout' => 'plugins.persistent-data.forget_on_logout'
                ],
                'problems' => [
