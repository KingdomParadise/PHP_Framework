			...
			<div class="parallax-wrapper">
            	<div class="vc_col-sm-12 wpb_column vc_column_container">
                	<div class="wpb_wrapper">
						<?php
                            query_posts( array(
                                'cat'				=> logipro_get_ozy_data('_blog_include_categories'),
                                'post_type' 		=> 'post',
                                'post_status'		=> 'publish',
                                'orderby' 			=> logipro_get_ozy_data('_blog_orderby'),
                                'order' 			=> logipro_get_ozy_data('_blog_order'),
								'posts_per_page'	=> logipro_get_ozy_data('_blog_post_per_load'),
						...
						<?php
                            ...
                            <div>
								...
								if(!$hide_title && 'audio' !== $ozy_current_post_format) { 
									echo '<div class="post-submeta"><a href="'. esc_url(get_permalink()) .'">'. esc_attr__('READ MORE', 'logipro') . '<img src="'. LOGIPRO_OZY_BASE_URL .'images/right-arrow.svg" class="svg arrow_hover"/></a></div>'; 
								}
                                ?>
                			</div>
                        </div><!--.post-single-->        
