...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected' => esc_attr__( 'No File Selected', 'logipro' ),
				'remove'         => esc_attr__( 'Remove', 'logipro' ),
				'default'        => esc_attr__( 'Default', 'logipro' ),
				'selectFile'     => esc_attr__( 'Select File', 'logipro' ),
				'standardFonts'  => esc_attr__( 'Standard Fonts', 'logipro' ),
				'googleFonts'    => esc_attr__( 'Google Fonts', 'logipro' ),
			)
		);
