...
class Kirki_Control_Image extends Kirki_Control_Base {
	...
	protected function content_template() {
		...
		data.choices.labels = _.defaults( data.choices.labels, {
			select: '<?php esc_attr_e( 'Select image', 'logipro' ); ?>',
			change: '<?php esc_attr_e( 'Change image', 'logipro' ); ?>',
			'default': '<?php esc_attr_e( 'Default', 'logipro' ); ?>',
			remove: '<?php esc_attr_e( 'Remove', 'logipro' ); ?>',
			placeholder: '<?php esc_attr_e( 'No image selected', 'logipro' ); ?>',
			frame_title: '<?php esc_attr_e( 'Select image', 'logipro' ); ?>',
			frame_button: '<?php esc_attr_e( 'Choose image', 'logipro' ); ?>',
		} );
		#>
		<label>
