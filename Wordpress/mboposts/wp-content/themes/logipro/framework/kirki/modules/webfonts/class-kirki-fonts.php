...
final class Kirki_Fonts {
	...
	public static function get_all_variants() {
		return array(
			'100'       => esc_attr__( 'Ultra-Light 100', 'logipro' ),
			'100light'  => esc_attr__( 'Ultra-Light 100', 'logipro' ),
			'100italic' => esc_attr__( 'Ultra-Light 100 Italic', 'logipro' ),
			'200'       => esc_attr__( 'Light 200', 'logipro' ),
			'200italic' => esc_attr__( 'Light 200 Italic', 'logipro' ),
			'300'       => esc_attr__( 'Book 300', 'logipro' ),
			'300italic' => esc_attr__( 'Book 300 Italic', 'logipro' ),
			'400'       => esc_attr__( 'Normal 400', 'logipro' ),
			'regular'   => esc_attr__( 'Normal 400', 'logipro' ),
			'italic'    => esc_attr__( 'Normal 400 Italic', 'logipro' ),
			'500'       => esc_attr__( 'Medium 500', 'logipro' ),
			'500italic' => esc_attr__( 'Medium 500 Italic', 'logipro' ),
			'600'       => esc_attr__( 'Semi-Bold 600', 'logipro' ),
			'600bold'   => esc_attr__( 'Semi-Bold 600', 'logipro' ),
			'600italic' => esc_attr__( 'Semi-Bold 600 Italic', 'logipro' ),
			'700'       => esc_attr__( 'Bold 700', 'logipro' ),
			'700italic' => esc_attr__( 'Bold 700 Italic', 'logipro' ),
			'800'       => esc_attr__( 'Extra-Bold 800', 'logipro' ),
			'800bold'   => esc_attr__( 'Extra-Bold 800', 'logipro' ),
			'800italic' => esc_attr__( 'Extra-Bold 800 Italic', 'logipro' ),
			'900'       => esc_attr__( 'Ultra-Bold 900', 'logipro' ),
			'900bold'   => esc_attr__( 'Ultra-Bold 900', 'logipro' ),
			'900italic' => esc_attr__( 'Ultra-Bold 900 Italic', 'logipro' ),
		);
	}
