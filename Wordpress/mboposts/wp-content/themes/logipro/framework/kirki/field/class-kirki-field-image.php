...
class Kirki_Field_Image extends Kirki_Field {
	...
	protected function set_button_labels() {
		$this->button_labels = wp_parse_args( $this->button_labels,
			array(
				'select'       => esc_attr__( 'Select image', 'logipro' ),
				'change'       => esc_attr__( 'Change image', 'logipro' ),
				'default'      => esc_attr__( 'Default', 'logipro' ),
				'remove'       => esc_attr__( 'Remove', 'logipro' ),
				'placeholder'  => esc_attr__( 'No image selected', 'logipro' ),
				'frame_title'  => esc_attr__( 'Select image', 'logipro' ),
				'frame_button' => esc_attr__( 'Choose image', 'logipro' ),
			)
		);
	}
