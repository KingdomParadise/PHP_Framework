...
class WPAlchemy_MetaBox
{
	...
	function the_id()
	{
		logipro_e_html($this->get_the_id());
	}
	...
	{
		logipro_e_html($this->get_the_value($n));
	}
	...
	{
		logipro_e_html($this->get_the_name($n));
	}
	...
	function the_index()
	{
		logipro_e_html($this->get_the_index());
	}
	...
	{
		logipro_e_html($this->get_the_checkbox_state($n, $v));
	}
	...
	{
		logipro_e_html($this->get_the_select_state($n, $v));
	}
	...
	{
		logipro_e_html($this->get_the_group_open($t));
	}
	...
	{
		logipro_e_html($this->get_the_group_close());
	}
	...
	function get_the_current_group_count()
	{
		...
		return is_array($meta) ? count($meta) : null;
	}
...
class WPA_Loop
{
	...
	{
		logipro_e_html($this->get_the_indexed_name());
	}
