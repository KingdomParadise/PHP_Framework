<div class="wrap">
	<h2><?php logipro_e_html($set->get_title()); ?></h2>
					...
					<ul class="vp-menu-level-1">
						...
						<?php endif; ?>
							...
							<?php endif; ?>
								...
								?>
								<span><?php logipro_e_html($menu->get_title()); ?></span>
							</a>
							<?php if ($menu->get_menus()): ?>
							<ul class="vp-menu-level-2">
								...
								<?php endif; ?>
									<a href="#<?php echo esc_attr($submenu->get_name()); ?>" class="vp-js-menu-goto vp-menu-goto">
										...
										?>
										<span><?php logipro_e_html($submenu->get_title()); ?></span>
									</a>
								</li>
								<?php endforeach; ?>
							</ul>
			...
			<div class="vp-right-panel">
				<form id="vp-option-form" class="vp-option-form vp-js-option-form" method="POST">
					<div id="vp-submit-top" class="vp-submit top">
						<div class="inner">
							<input class="vp-save vp-button button button-primary" type="submit" value="<?php esc_attr_e('Save Changes', 'logipro'); ?>" />
							<p class="vp-js-save-loader save-loader" style="display: none;"><img src="<?php VP_Util_Res::img_out('ajax-loader.gif', ''); ?>" /><?php esc_attr_e('Saving Now', 'logipro'); ?></p>
					...
					<?php if ($menu === reset($menus)): ?>
						<?php logipro_e_html($menu->render(array('current' => 1))); ?>
					<?php else: ?>
						<?php logipro_e_html($menu->render(array('current' => 0))); ?>
					<?php endif; ?>
					<?php endforeach; ?>
