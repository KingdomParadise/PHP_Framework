...
?>
	<div id="content" class="<?php echo esc_attr(logipro_get_ozy_data('_page_content_css_name')); ?> author-page">
                	...
                	<div class="wpb_wrapper">
                        ...
                        <div class="author-bio">
                            ...
                            <?php if($curauth->description !="") { /* Displays the author's description from their Wordpress profile */ ?>
                                <p><?php echo esc_html($curauth->description); ?></a></p>
                            <?php } ?>
                            
                            <h3 class="page-title"><?php esc_attr_e('Recent Posts by ', 'logipro'); echo esc_html($curauth->display_name); ?></h3>
                        </div>                        
                        ...
                        <?php							
                            ...
                            if (have_posts()) : while (have_posts()) : the_post(); 
                                ...
                                if($post->post_excerpt) {
                                    ...
                                    if('gallery' === logipro_get_ozy_data('ozy_current_post_format')) {
                        ...
                        <div id="recent-author-comments">
                            <h3 class="page-title"><?php esc_attr_e('Recent Comments by ', 'logipro'); echo esc_html($curauth->display_name); ?></h3>
                            <?php
                            ...
                            <ul>
                                <?php
                                    ...
                                    echo  '<li class="recentcomments"><i class="oic-bubble"></i>&nbsp;' . sprintf(esc_attr__('%1$s on %2$s', 'logipro'), get_comment_date(), '<a href="'. get_comment_link($comment->comment_ID) . '">' . get_the_title($comment->comment_post_ID) . '</a>') . '</li>';
                                endforeach; else: ?>
                                    <p><?php esc_attr_e('No comments by ', 'logipro'); echo esc_html($curauth->display_name); ?></p>
                                <?php endif; ?>
                            </ul>
