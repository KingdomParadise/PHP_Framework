...
function fca_ga_settings_page() {
	...
	$html = '<form style="display: none" action="" method="post" id="fca_ga_main_form">';
		...
		$html .= '<table class="fca_ga_setting_table" >';
			$html .= "<tr>";
				$html .= '<th>' . __('Google Analytics Tracking ID', 'fca-ga') . '</th>';
				$html .= '<td id="fca-ga-helptext" title="' . __('Your Google Analytics Tracking ID should only contain numbers', 'fca-ga') . '" >' . fca_ga_input ( 'id', 'e.g. UA-12345678-1', $id, 'text' );
				$html .= '<a class="fca_ga_hint" href="https://fatcatapps.com/analytics-cat-quick-start#ga-id" target="_blank">' . __( 'What is my Google Analytics Tracking ID?', 'fca-ga' ) . '</a>';
				$html .= '</td>';
			$html .= "</tr>";
			$html .= "<tr>";
