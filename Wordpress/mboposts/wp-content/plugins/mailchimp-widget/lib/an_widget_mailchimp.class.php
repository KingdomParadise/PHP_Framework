...
class AN_Widget_MailChimp extends Widget_Default_AN_MC {
	...
	public function __construct() {
		...
		$this->setName( __( 'NEWSLETTER', 'another-mailchimp-widget' ) );
	...
	public function widget( $args, $instance ) {
		...
		$defaults = array(
			...
			'email_text'      => __( 'ENTER YOUR EMAIL', 'another-mailchimp-widget' ),
			'collect_first'   => false,
			'collect_last'    => false,
			'old_markup'      => false,
		...
		$sub_title = empty( $instance[ 'sub_title' ] ) ? '' : '<p>' . $instance[ 'sub_title' ] . '</p>';
		...
		if ( $this->successful_signup ) {
			...
			?> ns_widget_mailchimp_form">
				...
				<div class="ns_widget_mailchimp_email_input_wrapper">
					<input id="<?php echo $this->id_base . '-email-' . $this->number; ?>" type="email" name="<?php echo $this->id_base . '_email' ?>" placeholder="<?php echo esc_attr($email_text) ?>" autocomplete="off" required />
					<button class="mpam-submit button" id="mc_signup_submit" type="submit" name="<?php echo strtolower( $signup_text ); ?>" title="<?php echo esc_attr($signup_text); ?>">
						<img src="<?php echo plugins_url( '../images/right-arrow.svg', __FILE__ ) ?>" class="svg" alt=""/>
					</button>
				</div>				
	...
	public function form( $instance ) {
		...
		if ( ! $api_key ) {
			...
			<div class="mpam-widget-wrapper">
				...
				<p>
					<label for="<?php echo $this->get_field_id( 'sub_title' ); ?>"><?php _e( 'Sub Title', 'another-mailchimp-widget' ); ?></label>
				...
				<p>
					<label for="<?php echo $this->get_field_id( 'description' ); ?>"><?php _e( 'Description', 'another-mailchimp-widget' ); ?></label>
					<textarea class="widefat" id="<?php echo $this->get_field_id( 'description' ); ?>" name="<?php echo $this->get_field_name( 'description' ); ?>" rows="5"><?php echo $description; ?></textarea>
				</p>				
